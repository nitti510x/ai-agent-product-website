        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-text-muted mb-6">
              At OpAgents, we're on a mission to revolutionize marketing workflows by bringing AI-powered assistance directly into Slack. 
          ...
          <div className="bg-dark-lighter p-8 rounded-xl border border-dark-card">
            ...
            <p className="text-text-muted mb-4">
              Founded in 2025, OpAgents was born out of the need for a more efficient marketing workflow. 
