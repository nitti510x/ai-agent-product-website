        ...
        <div className="max-w-3xl mx-auto">
          <section className="mb-12">
            ...
            <p className="text-text-muted mb-4">
              By accessing or using OpAgents services, you agree to be bound by these Terms of Service. 
          ...
          <section className="mb-12">
            ...
            <p className="text-text-muted mb-4">
              OpAgents provides AI-powered marketing assistance through Slack. Our services include content creation, 
          ...
          <section className="mb-12">
            ...
            <p className="text-text-muted mb-4">
              All content, trademarks, and intellectual property rights in our services belong to OpAgents or its licensors. 
          ...
          <section className="mb-12">
            ...
            <p className="text-text-muted mb-4">
              OpAgents is not liable for any indirect, incidental, or consequential damages arising from the use of our services.
            </p>
          </section>
