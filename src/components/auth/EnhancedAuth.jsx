        ...
        {view !== 'forgot_password' && (
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#F7F7F7] hover:bg-gray-100 text-gray-800 rounded-xl transition-colors duration-300 font-bold"
              disabled={loading}
            >
              <SlackLogo className="w-5 h-5" />
              <span className="font-bold">Continue with Slack</span>
            </button>
