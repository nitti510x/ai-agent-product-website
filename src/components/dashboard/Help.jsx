...
function Help() {
  return (
    <div>
      <PageHeader 
        title="Help & Support"
        description="Get assistance with your AI assistants and token usage"
      />
      ...
      <div className="bg-[#1A1E23] rounded-2xl shadow-2xl border border-dark-card/30 p-6 mb-8">
        ...
        <div className="space-y-4">
          <div className="border-b border-gray-700 pb-4">
            <h4 className="text-white font-bold mb-2">What are tokens and how do they work?</h4>
          ...
          <div className="border-b border-gray-700 pb-4">
            <h4 className="text-white font-bold mb-2">How do I know when I'm running low on tokens?</h4>
            <p className="text-gray-400">
          ...
          <div className="border-b border-gray-700 pb-4">
            <h4 className="text-white font-bold mb-2">What's the difference between plan tokens and token packs?</h4>
            <p className="text-gray-400">
          ...
          <div className="border-b border-gray-700 pb-4">
            <h4 className="text-white font-bold mb-2">How do I upgrade my subscription?</h4>
            <p className="text-gray-400">
          ...
          <div>
            <h4 className="text-white font-bold mb-2">Can I integrate the AI assistants with other tools?</h4>
            <p className="text-gray-400">
