  ...
  const getAgentIcon = (systemName, isMainAgent = true, isGray = false) => {
    switch (systemName) {
      ...
      case 'tiktok_influencer_agent':
        // TikTok logo SVG with fill-current to ensure proper color
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className={`w-8 h-8 ${isGray ? 'text-gray-500' : 'text-emerald-400'} fill-current`}>
      ...
      case 'x_influencer_agent':
        ...
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={`w-8 h-8 ${isGray ? 'text-gray-500' : 'text-emerald-400'} fill-current`}>
